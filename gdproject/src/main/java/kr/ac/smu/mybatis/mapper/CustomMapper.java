...
public interface CustomMapper {
	...
	@Select("SELECT distinct customName FROM custom WHERE user_id=#{userId}")
	public List<String> selectCustomList(@Param("userId") String userId);
	...
	@Insert("INSERT INTO custom VALUES(#{pre.user_id},#{pre.id},#{pre.customName})")
